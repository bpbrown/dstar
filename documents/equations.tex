...
\begin{equation}
  \partial_t s + \vec{u}\cdot \del s = \frac{K(r)}{\rho_0} \exp(-\Upsilon)\mathcal{D}^2(\theta) + \frac{c_P \mu}{2 \rho_0 h_0} \exp(-\Upsilon) \exp(-\theta)\mathrm{Tr}(E^2) + \mathcal{S}
\end{equation}
with:
\begin{equation}
\mathcal{D}^2(\theta) = \nabla^2 \theta + 2\left(\nabla \ln h_0 \cdot \nabla \theta \right) + \left(\nabla \theta \right)^2 + \del \ln K \cdot \del \theta
...
and with:
\begin{equation}
\mathcal{S} = c_P \epsilon \frac{1}{h_0}\exp(-\theta) + \frac{K(r)}{h_0 \rho_0} \exp(-\Upsilon) \left[\nabla^2 h_0 + \del \ln K \cdot \del h_0 \right]
\end{equation}
or
\begin{equation}
\mathcal{S} = c_P \epsilon \frac{1}{h_0}\exp(-\theta) + \frac{K(r)}{\rho_0} \exp(-\Upsilon) \nabla^2 \ln h_0 + (\nabla \ln h_0)^2
+ \del \ln K \cdot \del \ln h_0
\end{equation}
...
\begin{equation}
  \partial_t s + \vec{u}\cdot \del s =
  \frac{K}{c_P \rho_c u_c L} \frac{1}{\rho_0} \exp(-\Upsilon)\mathcal{D}^2(\theta)
  + \frac{\mu}{2 \rho_c u_c L}\frac{u_c^2}{h_c}\frac{1}{\rho_0 h_0}\exp(-\Upsilon) \exp(-\theta)\mathrm{Tr}(E^2)
  + \frac{L}{u_c}\frac{\mathcal{S}}{c_P}
\end{equation}
...
\begin{equation}
  \partial_t s + \vec{u}\cdot \del s =
  \frac{1}{\scrP} \frac{1}{\rho_0} \exp(-\Upsilon)\mathcal{D}^2(\theta)
...
\begin{equation}
  \partial_t s + \vec{u}\cdot \del s =
  \frac{K/(c_P \rho_c)}{2 \Omega L^2} \frac{1}{\rho_0} \exp(-\Upsilon)\mathcal{D}^2(\theta)
